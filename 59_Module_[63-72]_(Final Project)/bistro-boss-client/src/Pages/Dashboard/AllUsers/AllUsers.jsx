        ...
        <div>
            ...
            <div className="overflow-x-auto">
                <table className="table w-full">
                    ...
                    <tbody>
                        {
                            users.map((user, index) => <tr className="text-white" key={user._id}>
                                ...
                                <td>
                                    {user.role ? 'Admin':<button
                                        ...
                                        className="btn btn-ghost btn-lg"><FaUsers className="text-white text-xl"></FaUsers>
                                    </button>}
                                </td>
                                <td>
                                    <button
                                        onClick={() => handleDeleteUser(user)}
                                        className="btn btn-ghost btn-lg"><FaTrashAlt className="text-red-600 text-xl"></FaTrashAlt>
                                    </button>
                                </td>
                            </tr>)
                        }
